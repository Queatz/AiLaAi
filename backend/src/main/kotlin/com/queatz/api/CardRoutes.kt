...
import com.queatz.push.CollaborationEventData
        ...
        get("/cards") {
            respond {
                ...
                db.explore(
                    ...
                    search = search,
                    availableToday = call.parameters["availableToday"]?.toBooleanStrictOrNull(),
                    availableTomorrow = call.parameters["availableTomorrow"]?.toBooleanStrictOrNull(),
